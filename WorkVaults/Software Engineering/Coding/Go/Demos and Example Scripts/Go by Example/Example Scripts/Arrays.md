In Go, an _array_ is a numbered sequence of elements of a specific length. In typical Go code, [slices](https://gobyexample.com/slices) are much more common; arrays are useful in some special scenarios.
```Go
package main
